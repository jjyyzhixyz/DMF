...
Abstract:
    ...
    General utility functions that are specific to Tests library.
    This is not a Module. It is a set of functions that are called without using DMFMODULE.
...
Routine Description:
    ...
    This function generates a random number withing a specified range.
...
Routine Description:
    ...
    This function populates the buffer with sequential 
    data, that starts from a random number.
    ...
    --*/
{
    ...
    {
        // Ignore integer overflow, just restart from zero.
        //
...
Routine Description:
    ...
    This function forces scheduler to yield execution to another thread.
